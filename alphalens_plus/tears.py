...
def create_returns_tear_sheet(
    factor_data, long_short=True, group_neutral=False, by_group=False, img_path=None
):
    """
...
def create_information_tear_sheet(
    factor_data, group_neutral=False, by_group=False, img_path=None
):
    """
...
@plotting.customize
def create_turnover_tear_sheet(factor_data, turnover_periods=None, img_path=None):
    """
...
def create_full_tear_sheet(factor_data,
    ...
    plotting.plot_quantile_statistics_table(factor_data)
    rpath = img_path.format('returns')
    create_returns_tear_sheet(
        factor_data, long_short, group_neutral, by_group, set_context=False, img_path=rpath
    )
    ipath = img_path.format('info')
    create_information_tear_sheet(
        factor_data, group_neutral, by_group, set_context=False, img_path=ipath
    )
    tpath = img_path.format('turnover')
    create_turnover_tear_sheet(
        factor_data, set_context=False, img_path=tpath
    )
